...
If you want to use this extension, you need to add the `io.quarkiverse.mapstruct:quarkus-mapstruct` extension first to your build file.
...
include::includes/quarkus-mapstruct.adoc[leveloffset=+1, opts=optional]
